Contributing to Exsolution Core
============================

The Exsolution Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Exsolution Core project, and is not to be
confused with overall Exsolution Network Protocol consensus changes.

Whether a pull request is merged into Exsolution Core rests with the project merge
...
Patches that change Exsolution consensus rules are considerably more involved than
...
Where a patch set proposes to change the Exsolution consensus, it must have been
...
The project leader is the release manager for each Exsolution Core release.
