...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/exsolution-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/Darksend.cpp \
           src/exsolution-cli.cpp \
           src/exsolution-tx.cpp \
           src/exsolution.cpp \
           src/db.cpp \
           ...
           src/qt/exsolution.cpp \
           src/qt/exsolutionstrings.cpp \
...
RESOURCES += src/qt/exsolution.qrc src/qt/exsolution_locale.qrc

TRANSLATIONS += src/qt/locale/exsolution_bg.ts \
                src/qt/locale/exsolution_de.ts \
                src/qt/locale/exsolution_en.ts \
                src/qt/locale/exsolution_es.ts \
                src/qt/locale/exsolution_fi.ts \
                src/qt/locale/exsolution_fr.ts \
                src/qt/locale/exsolution_it.ts \
                src/qt/locale/exsolution_ja.ts \
                src/qt/locale/exsolution_pl.ts \
                src/qt/locale/exsolution_pt.ts \
                src/qt/locale/exsolution_ru.ts \
                src/qt/locale/exsolution_sk.ts \
                src/qt/locale/exsolution_sv.ts \
                src/qt/locale/exsolution_vi.ts \
                src/qt/locale/exsolution_zh_CN.ts \
                src/qt/locale/exsolution_zh_TW.ts
