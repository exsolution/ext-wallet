...
In order to support loading of multiple wallets in exsolution-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is exsolution.cpp.
...
Changes to exsolution.cpp
----------------------
exsolution.cpp is the entry point into exsolution-qt, and as such, will require some minor modifications to provide hooks for
