...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Exsolution Core exsolution-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  exsolution-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded exsolution transaction") + "\n" +
                               "  exsolution-tx [options] -create [commands]   " + _("Create hex-encoded exsolution transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded exsolution transaction
