...
#if defined(NDEBUG)
#error "Exsolution cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Exsolution Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight > 1)      nSubsidy = COIN * 75;
	if (nHeight > 19710)  nSubsidy = COIN * 100;
	if (nHeight > 39420)  nSubsidy = COIN * 300;
	if (nHeight > 78840)  nSubsidy = COIN * 150;
	if (nHeight > 157680) nSubsidy = COIN * 74;
	if (nHeight > 236520) nSubsidy = COIN * 64;
	if (nHeight > 315360) nSubsidy = COIN * 60;
	if (nHeight > 394200) nSubsidy = COIN * 48;
	if (nHeight > 473040) nSubsidy = COIN * 36;
	if (nHeight > 551880) nSubsidy = COIN * 24;
	if (nHeight > 630720) nSubsidy = COIN * 14;
	if (nHeight > 709560) nSubsidy = COIN * 8;
	if (nHeight > 788400) nSubsidy = COIN * 6;
...
{
    RenameThread("exsolution-scriptch");
