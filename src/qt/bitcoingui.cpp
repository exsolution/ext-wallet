                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Exsolution Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EXT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and exsolution: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Exsolution Core"), this);
    aboutAction->setStatusTip(tr("Show information about Exsolution Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EXT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EXT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EXT addresses"));
    ...
    openAction->setStatusTip(tr("Open a EXT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Exsolution Core help message to get a list with possible EXT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Exsolution Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to the Exsolution network", "", count));
}
...
{
    QString strTitle = tr("Exsolution Core"); // default title
    ...
    // Append title to "Exsolution Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
...
void UnitDisplayStatusBarControl::updateDisplayUnit(int newUnits)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        setText("testnet-" + BitcoinUnits::name(newUnits));
    }
/*    if (Params().NetworkID() == CBaseChainParams::MAIN) {
