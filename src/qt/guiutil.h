...
/** Utility functions used by the Exsolution Qt UI.
 */
namespace GUIUtil
{
...
// Render EXT addresses in monospace font
...
// Parse "exsolution:" URI into recipient object, return true on successful parsing
