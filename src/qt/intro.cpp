...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Exsolution Core"),
     ...
     * override -datadir in the exsolution.conf file in the default data directory
     * (to be consistent with exsolutiond behavior)
     */
    if (dataDir != getDefaultDataDirectory())
