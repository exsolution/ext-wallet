...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Exsolution server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Exsolution server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Exsolution features */
        {"exsolution", "masternode", &masternode, true, true, false},
        {"exsolution", "masternodelist", &masternodelist, true, true, false},
        {"exsolution", "mnbudget", &mnbudget, true, true, false},
        {"exsolution", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"exsolution", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"exsolution", "mnsync", &mnsync, true, true, false},
        {"exsolution", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"exsolution", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use exsolutiond, or the -server option to exsolution-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> exsolution-cli " + methodname + " " + args + "\n";
}
